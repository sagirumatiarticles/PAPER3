...
kable(format="latex",longtable=T,booktabs=T,caption="\\bfseries{Correlation of inflationary shocks: M2 and M3.}",escape=F,linesep="",col.names=NULL,align=c("l","c","c","c","c","c","c","c","c")) %>%
kable_styling(latex_options = c("basic"),full_width=T,font_size=9) %>%
...
kable(format="latex",longtable=T,booktabs=T,caption="\\bfseries{Correlation of inflationary shocks: M5 and M6.}",escape=F,linesep="",col.names=NULL) %>%
kable_styling(latex_options = c("basic"),full_width=T,font_size=9) %>%
